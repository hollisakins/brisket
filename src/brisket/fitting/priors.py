...
class Uniform(Prior):
    ...
    def __init__(self, low, high):
        # Initialise the parent
        super().__init__(name="Uniform", low=low, high=high)
...
class LogUniform(Prior):
    ...
    def __init__(self, low, high):
        # Initialise the parent
        super().__init__(name="LogUniform", low=low, high=high)
...
class StudentsT(Prior):
    ...
    def __init__(self, low, high, loc=0, scale=0.3, df=2):
        # Initialise the parent
        super().__init__(name="StudentsT", low=low, high=high, loc=loc, scale=scale, df=df)
...
class PriorVolume(object):
    ...
    Parameters
    ----------
    priors : list of priors (instances of harmonizer.fitting.priors.Prior)
    """
