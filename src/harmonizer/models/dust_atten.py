...
class DustAttenuationModel:
    ...
    def _Alam(self, params):
        """
        Prototype for child defined attenuation curves.
        """
...
class CalzettiDustAttenuationModel(DustAttenuationModel):
    def __init__(self, wavelengths, params):
...
class CardelliDustAttenuationModel(DustAttenuationModel):
    def __init__(self, wavelengths, params):
        super().__init__(wavelengths, params)
...
class SMCDustAttenuationModel(DustAttenuationModel):
    def __init__(self, wavelengths, params):
        super().__init__(wavelengths, params)
...
class SalimDustAttenuationModel(DustAttenuationModel):
    def __init__(self, wavelengths, params):
        super().__init__(wavelengths, params)
...
class CF00DustAttenuationModel(DustAttenuationModel):
    def __init__(self, wavelengths, params):
        super().__init__(wavelengths, params)
