...
class dust_emission(object):
    ...
    def __init__(self, wavelengths, params, logger=utils.NullLogger):
        ...
        self.logger.info(f"Initializing dust emission module".ljust(50) + f'()'.rjust(20))

    def spectrum(self, params):
        """ Get the 1D spectrum for a given set of model parameters. """

        qpah, umin, gamma = params['dust_emission']['qpah'], params['dust_emission']['umin'], params['dust_emission']['gamma']
