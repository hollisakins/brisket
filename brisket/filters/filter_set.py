...
#### Identical to bagpipes/filters/filter_set.py, but points to config.filter_dir instead of the install directory
class filter_set(object):
    ...
    def __init__(self, filt_list, logger=utils.NullLogger):
    ...
    def _load_filter_curves(self):
        ...
        #     except IOError:
        #         self.filt_dict[filt] = np.loadtxt(config.filter_dir + "/"
        #                                         + filt, usecols=(0, 1))
